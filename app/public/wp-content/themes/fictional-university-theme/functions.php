...
function university_files()
{
    ...
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDaYIthRudaacnSg9HTEhVHieQslvAHrvw', NULL, '1.0', true);
...
{
    $api['key'] = 'AIzaSyDaYIthRudaacnSg9HTEhVHieQslvAHrvw';
    return $api;
}
