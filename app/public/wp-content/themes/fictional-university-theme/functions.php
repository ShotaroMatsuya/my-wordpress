...
function university_files()
{
    ...
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyA-fz5p29OJYYHSo-KynE5lTjhXbXTuSHA', NULL, '1.0', true);
...
{
    $api['key'] = 'AIzaSyA-fz5p29OJYYHSo-KynE5lTjhXbXTuSHA';
    return $api;
}
