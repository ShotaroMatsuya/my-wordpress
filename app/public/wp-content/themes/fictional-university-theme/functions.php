...
function university_files()
{
    ...
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDvmdUBHKmgQB9m96FD4yEHwUjMT1cEQj8', NULL, '1.0', true);
...
{
    $api['key'] = 'AIzaSyDvmdUBHKmgQB9m96FD4yEHwUjMT1cEQj8';
    return $api;
}
